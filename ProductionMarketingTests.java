//YOU'LL NEED TO UPDATE THE [##] OF CERTAIN ADS LIKE THE THE CLEAR AD!!!
...
public class ProductionMarketingTests {
  ...
  public void setUp() throws Exception {
    ...
    baseUrl = "http://www.spongecell.com";
  ...
  public void testDynamicSignalValueJUnit4() throws Exception {
    ...
    //Filtering Breadcrumb//
          ...
          driver.findElement(By.xpath("(//a[contains(text(),'300 x 250')])[89]")).click();
